        ...
        <div>
            <div className="flex-1">
                <div className="bg-white p-6 ">
                        ...
                        <table className="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody className="bg-white divide-y divide-gray-200">
                                <tr>
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap">Backlog Subject Form Fee (Theory or Practical)</td>
                                    <td className="px-6 py-4 whitespace-nowrap">Rs. 1000/- (Per Subject)</td>
                                    <td className="px-6 py-4 whitespace-nowrap">Online through Student Portal</td>
                                </tr>
                                <tr className="bg-gray-50">
                                    <td className="px-6 py-4 whitespace-nowrap">
                                        2
                                    </td>
                                    <td className="px-6 py-4 whitespace-nowrap">Percentage Certificate</td>
                                    <td className="px-6 py-4 whitespace-nowrap">Rs. 1000/= + GST(18%)</td>
                                    <td className="px-6 py-4 whitespace-nowrap">Online through Student Portal</td>
                                </tr>
                                <tr>
                                    <td className="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap">Correction in Name on Grade Card</td>
                                    <td className="px-6 py-4 whitespace-nowrap">Rs. 500/- (Per Grade Card)
                                        <Link
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap">To pay the fees
                                        <Link
                                ...
                                <tr className="bg-gray-50">
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap">Duplicate Grade Card</td>
                                    <td className="px-6 py-4 whitespace-nowrap">Rs. 500/- (Per Grade Card)
                                        <Link
                                ...
                                <tr className="bg-gray-50">
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap"> Transcript Copies</td>
                                    <td className="px-6 py-4 whitespace-nowrap">Rs. 1000/- (First Copy) Rs. 500/- (For each subsequent copy)<br />
                                        If payment issue please Download the form and submit to the<br />CoE office with payment details
                                        <Link
                                ...
                                <tr className="bg-gray-50">
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap">Correction in Name on Degree Certificate<br />
                                        & Duplicate Degree Certificate </td>
                                    <td className="px-6 py-4 whitespace-nowrap">Rs. 2,000/-
                                        <Link
                                ...
                                <tr className="bg-gray-50">
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap">Procedure & Application for Name Change<br />(After Gazette)</td>
                                    <td className="px-6 py-4 whitespace-nowrap">Rs. 2,000/-
                                        <Link
                                ...
                                <tr className="bg-gray-50">
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap">NO DUES for Obtaining<br />DEGREE CERTIFICATE IN PERSON</td>
                                    <td className="px-6 py-4 whitespace-nowrap">
                                        <Link
                                ...
                                <tr className="bg-gray-50">
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap">Application For Refund of Exam Fees</td>
                                    <td className="px-6 py-4 whitespace-nowrap">
                                        <Link
                                ...
                                <tr className="bg-gray-50">
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap">Application Form for Migration Certificate<br />issuing by the Registrar's Office</td>
                                    <td className="px-6 py-4 whitespace-nowrap">
                                        <Link
                                ...
                                <tr className="bg-gray-50">
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap">NO DUES for Obtaining Ph.D. Notification</td>
                                    <td className="px-6 py-4 whitespace-nowrap">
                                        <Link
                    ...
                    <br />
                    <p>Academic Ordinances-2021.110 Clause (3): MAXIMUM DURATION FOR THE COMPLETION OF A PROGRAMME</p>
                    <br />
                    <p>The Maximum duration for the completion of a programme, shall be as detailed below:</p>
                    <br />
