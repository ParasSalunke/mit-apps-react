        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div class="py-16 flex justify-between items-center flex-col gap-8 lg:flex-row">
            ...
            <div class="flex  space-x-4 sm:justify-center  ">
              <Link
                to="https://twitter.com/mitadtpune"
                target="_blank"
              ...
              <Link
                to="https://www.instagram.com/mitadtuniversity"
                target="_blank"
                class="w-9 h-9 rounded-full bg-gray-800 flex justify-center items-center hover:bg-indigo-600"
              >
                <svg
              ...
              <Link
                to="https://www.linkedin.com/school/mit-adtuniversity/posts"
                target="_blank"
                class="w-9 h-9 rounded-full bg-gray-800 flex justify-center items-center hover:bg-indigo-600"
              >
                <svg
              ...
              <Link
                to="https://www.youtube.com/c/MITADTUniversityPune"
                target="_blank"
                class="w-9 h-9 rounded-full bg-gray-800 flex justify-center items-center hover:bg-indigo-600"
              >
                <svg
          ...
          <div class="py-7 border-t border-gray-700">
            <div class="flex items-center justify-center">
              <span class="text-gray-400 ">
                ©<Link to="/">Mit Adt Apps </Link>2024, All rights reserved.
              </span>
            </div>
          </div>
        </div>
