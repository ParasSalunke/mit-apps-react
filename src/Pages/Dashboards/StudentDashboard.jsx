  ...
  return (
    <div className="flex h-screen bg-gray-100">
      ...
      <div
        ...
        } md:relative md:translate-x-0 transition-transform duration-300 ease-in-out w-64 bg-gray-800`}
      >
        <div className="flex items-center justify-between h-16 bg-gray-900 px-3">
          <img src={logo} alt="Logo" className="h-14 w-14" />
          <a
            href="/StudentDashboard"
            className="text-white font-bold uppercase pr-3 pl-2"
          >
            Student Dashboard
          </a>
          <button
        ...
        <div className="flex flex-col flex-1 overflow-y-auto">
          <nav className="flex-1 px-2 py-4 bg-gray-800 pt-5">
            <Link
              to="#"
              className="flex items-center px-5 py-2 text-gray-100 hover:bg-gray-700"
            ...
            <Link
              to="#"
              className="flex items-center px-5 py-2 text-gray-100 hover:bg-gray-700"
              onClick={() => handleNavigation("ExamForms")}
            >
            ...
            <Link
              to="#"
              className="flex items-center px-5 py-2 text-gray-100 hover:bg-gray-700"
              onClick={() => handleNavigation("GradeCards")}
            >
            ...
            <Link
              to="#"
              className="flex items-center px-5 py-2 text-gray-100 hover:bg-gray-700"
              onClick={() => handleNavigation("Redressal")}
            >
            ...
            <Link
              to="#"
              className="flex items-center px-5 py-2 text-gray-100 hover:bg-gray-700"
              onClick={() => handleNavigation("StudentServices")}
            >
